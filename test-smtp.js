...
const MAIL_FROM =
  ...
  `"EzyIntern Test" <${process.env.MAIL_FROM_ADDRESS || 'admin@ezyintern.in'}>`;
...
const sendTestMail = async () => {
  ...
  try {
    const info = await transporter.sendMail({
      from: MAIL_FROM,
      to,
      subject: 'EzyIntern SES SMTP test',
      html: '<p>Hello!</p><p>This is a test email from the EzyIntern SES SMTP setup.</p>',
    });
